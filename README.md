...
**Данные и статистика**
- Room: чаты, сообщения, ветки, провайдеры, модели, usage, черновики, MCP-серверы; миграции 1→2 и 2→3 без destructive fallback.
